  ...
  networks: {                                               // Define configuration for each network
    ...
    goerli: {
      providers: [
        ...
        {http: "https://goerli-eth.0xlend.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    ropsten: {
      providers: [
        ...
        {http: "https://ropsten-eth.0xlend.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    rinkeby: {
      providers: [
        ...
        {http: "https://rinkeby-eth.0xlend.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    kovan: {
      providers: [
        ...
        {http: "https://kovan-eth.0xlend.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    mainnet: {
      providers: [
        ...
        {http: "https://mainnet-eth.0xlend.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
