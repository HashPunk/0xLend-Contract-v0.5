...
const { xtrollerErr, TokenErr, IRErr, MathErr } = require('./Errors');
...
expect.extend({
  ...
  toHaveTrollError(actual, expectedErrorName) {
    return hasError.call(this, actual, expectedErrorName, xtrollerErr);
  },
  ...
  toHaveTrollFailure(result, err, info, detail=undefined) {
    return hasFailure.call(this, result, err, info, detail, xtrollerErr, 'toHaveTrollFailure');
  },
  ...
  toHaveTrollReject(result, info, detail) {
    return hasFailure.call(this, result, 'xtroller_REJECTION', info, detail && xtrollerErr.Error[detail], TokenErr, 'toHaveTrollReject');
  },

  toHaveTrollErrorTuple(result, tuple, cmp=undefined) {
    return hasErrorTuple.call(this, result, tuple, xtrollerErr, cmp);
  },
