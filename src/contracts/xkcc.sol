...
/**
 * @title 0xlend's xkcc Contract
 * @notice xtoken which wraps Ether
 * @author 0xlend
 */
contract xkcc is xtoken {
    /**
     * @notice Construct a new xkcc money market
     ...
     */
    constructor(xtrollerInterface xtroller_,
        ...
        initialize(xtroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_);
    ...
    function liquidateBorrow(address borrower, xtoken xtokenCollateral) external payable {
        (uint err,) = liquidateBorrowInternal(borrower, msg.value, xtokenCollateral);
    ...
    /**
     * @notice Send Ether to xkcc to mint
     */
